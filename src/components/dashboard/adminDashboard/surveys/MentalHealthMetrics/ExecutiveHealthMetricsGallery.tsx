...
export default function ExecutiveHealthMetricsGallery({ metrics }: MentalHealthMetricsProps) {
        ...
        const chartData = [
          {
            name: "Metric",
            value:
              metric.domain == "Clinical Risk Index" ? metric.avgRisk : metric.satisfactionScore,
            ...
            <div className="relative mx-auto mb-4 h-32 w-32">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                <div className="text-lg font-bold text-gray-900">
                  {metric.domain == "Clinical Risk Index"
                    ? metric.avgRisk
