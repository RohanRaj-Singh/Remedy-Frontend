...
import HealthMetricsGallery from "./MentalHealthMetrics/HealthMetricsGallery";
...
export default function MentalHealthMetrics({
  metrics,
  domainChartData,
  ...
  return (
    <Card className="w-full border-0 bg-transparent">
      ...
      <CardContent className="space-y-6 p-0 md:pt-6">
        <HealthMetricsGallery metrics={metrics} />
