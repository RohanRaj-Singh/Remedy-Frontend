      ...
      <div className="mb-6 flex w-full   items-center justify-between gap-4 lg:px-36">
        ...
        <div className="mb-6 hidden w-2/3 lg:block">
          <div className="mb-1 flex justify-between text-sm text-gray-600">
            <span>
              Completed {currentQuestion.isFollowUp ? (answeredCount - totalQuestions) : answeredCount}{" "}
              of {currentQuestion.isFollowUp ? followUpQuestions : totalQuestions || 0} {}
            </span>
      ...
      <div className="flex w-full items-center justify-center">
        <div className="my-4 rounded-xl md:p-6">
          <div className="mx-auto mb-6 min-w-60 md:max-w-5xl">
            ...
            <h1 className="text-md mx-auto mb-4 max-w-3xl py-4 text-center font-bold text-black md:py-8 md:text-2xl">
          ...
          <div className="z-10 mt-6 flex justify-end">
            <button
              ...
              className={`inline-flex items-center justify-center gap-3 rounded-full border border-white px-7 py-2 text-xs font-medium transition-all duration-300 hover:scale-105 md:text-lg ${currentAnswer && !isLoading ? "bg-green-600 text-white hover:bg-green-700" : "bg-gray-200 text-gray-400"} ${!currentAnswer || isLoading ? "cursor-not-allowed" : "cursor-pointer"}`}
            >
              Next
